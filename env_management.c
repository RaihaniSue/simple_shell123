 ...
 * @value: new value
 * @data: struct of the program's data
 * Return: 1 if the parameters are NULL, 2 if there is an error or 0 if sucess.
 */
...
/**
 * env_remove_key - removes key from environment
 * @key: the key to remove
 * @data: stucture of the program's data
 * Return: returns 1 if the key was removed, 0 if key does not exist;
 */
...
/**
 * print_environ - prints the current data environ
